...
<head>
	...
	<link rel="stylesheet" href="/weicmsClear/Public/Admin/js/codemirror/codemirror.css">
	<link rel="stylesheet" href="/weicmsClear/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css">
	<style>
		...
		#preview_window.loading{
			background: url('/weicmsClear/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
return array(
	...
	<script type="text/javascript" src="/weicmsClear/Public/Admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weicmsClear/Public/Admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weicmsClear/Public/Admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weicmsClear/Public/Admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/weicmsClear/Public/Admin/js/codemirror/php.js?v=<?php echo SITE_VERSION;?>"></script>

	<script type="text/javascript" src="/weicmsClear/Public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION;?>"></script>
